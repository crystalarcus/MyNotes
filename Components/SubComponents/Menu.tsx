...
import type { $Omit, InternalTheme } from 'react-native-paper/src/types';
...
const ANIMATION_DURATION_Short = 200;
const ANIMATION_DURATION_Long = 300;
// From the 'Standard easing' section of https://material.io/design/motion/speed.html#easing
const EASING_DEC = Easing.bezier(0.05, 0.7, 0.1, 1);
const EASING_ACC = Easing.bezier(0.3, 0, 0.8, 0.15);
...
class Menu extends React.Component<Props, State> {
            ...
            () => {
                ...
                Animated.parallel([
                    Animated.timing(this.state.scaleAnimation, {
                        ...
                        duration: this.props.scaleXAnimation ? ANIMATION_DURATION_Short : ANIMATION_DURATION_Long * animation.scale,
                        easing: EASING_DEC,
    ...
    private hide = () => {
        ...
        Animated.parallel([
            Animated.timing(this.state.scaleAnimation, {
                toValue: { x: 0, y: 0 },
                duration: (ANIMATION_DURATION_Short * animation.scale) - 80,
                easing: EASING_ACC,
                useNativeDriver: true,
            }),
            Animated.timing(this.state.opacityAnimation, {
    ...
    render() {
        ...
        const scaleTransforms = [
            {
                scaleX: this.props.scaleXAnimation ? scaleAnimation.x.interpolate({
